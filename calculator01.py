...
def btnClick(numbers):
    global operator
    #گلوبال تغییرات ایجاد شده احتمالی رو روی متغیر بیرونی اوپراتور اعمال میکنه
...
operator = ""
#یک رشته خالیه مه متغیر رو درونش نگه میداره
text_input = StringVar()
#با استفاده از متد استرینگ ور ورودی را از صفحه کلید دریافت میکنه
...
#برای ایجاد نمایشگر ماشین حساب از کلاس اینتری استفاده میشه. شی ما تی ایکس تی..
